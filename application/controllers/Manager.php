...
class Manager extends CI_Controller
{
    ...
    public function categories($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == 'add') {
            ...
            redirect(site_url('manager/categories'), 'refresh');
        } elseif ($param1 == "edit") {
    ...
    public function sub_categories_by_category_id($category_id = 0)
    {
        ...
        redirect(site_url("manager/sub_categories/$category_id"), 'refresh');
    }
    ...
    public function instructors($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == "add") {
            ...
            redirect(site_url('manager/instructors'), 'refresh');
        } elseif ($param1 == "edit") {
    ...
    public function users($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == "add") {
            ...
            redirect(site_url('manager/users'), 'refresh');
        } elseif ($param1 == "edit") {
            $this->user_model->edit_user($param2);
            redirect(site_url('manager/users'), 'refresh');
        } elseif ($param1 == "delete") {
    ...
    public function enrol_request($param1 = "",$param2 = "")
    {
        ...
        if ($param1 == 'edit_enrol_request') {
            ...
            redirect(site_url('manager/enrol_request'), 'refresh');
    ...
    public function system_settings($param1 = "")
    {
        ...
        if ($param1 == 'system_update') {
            ...
            redirect(site_url('manager/system_settings'), 'refresh');
        }
    ...
    public function frontend_settings($param1 = "")
    {
        ...
        if ($param1 == 'frontend_update') {
            ...
            redirect(site_url('manager/frontend_settings'), 'refresh');
        }
    ...
    public function payment_settings($param1 = "")
    {
        ...
        if ($param1 == 'system_currency') {
            ...
            redirect(site_url('manager/payment_settings'), 'refresh');
        }
    ...
    public function smtp_settings($param1 = "")
    {
        ...
        if ($param1 == 'update') {
            ...
            redirect(site_url('manager/smtp_settings'), 'refresh');
        }
    ...
    public function social_login_settings($param1 = "")
    {
        ...
        if ($param1 == 'update') {
            ...
            redirect(site_url('manager/social_login_settings'), 'refresh');
        }
    ...
    public function instructor_settings($param1 = "")
    {
        ...
        if ($param1 == 'update') {
            ...
            redirect(site_url('manager/instructor_settings'), 'refresh');
        }
    ...
    public function theme_actions($action = "", $theme = "")
    {
        ...
        if ($action == 'activate') {
            ...
            redirect(site_url('manager/theme_settings'), 'refresh');
        }
    }
    ...
    public function get_courses()
    {
        ...
        if (!empty($courses)) {
            foreach ($courses as $key => $row) {
                ...
                $edit_this_course_url = site_url('manager/course_form/course_edit/' . $row->id);
                $section_and_lesson_url = site_url('manager/course_form/course_edit/' . $row->id);
                ...
                if ($row->status == 'active') {
                    ...
                    if ($row->user_id != $this->session->userdata('user_id')) {
                        ...
                        $course_status_changing_action = "confirm_modal('" . site_url('manager/change_course_status_for_admin/pending/' . $row->id . '/' . $filter_data['selected_category_id'] . '/' . $filter_data['selected_instructor_id'] . '/' . $filter_data['selected_price'] . '/' . $filter_data['selected_status']) . "')";
                    }
                } else {
                    ...
                    if ($row->user_id != $this->session->userdata('user_id')) {
                        ...
                        $course_status_changing_action = "confirm_modal('" . site_url('manager/change_course_status_for_admin/active/' . $row->id . '/' . $filter_data['selected_category_id'] . '/' . $filter_data['selected_instructor_id'] . '/' . $filter_data['selected_price'] . '/' . $filter_data['selected_status']) . "')";
                    }
                }



                $delete_course_url = "confirm_modal('" . site_url('manager/course_actions/delete/' . $row->id) . "')";
    ...
    public function course_actions($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == "add") {
            ...
            redirect(site_url('manager/course_form/course_edit/' . $course_id), 'refresh');
            ...
            redirect(site_url('manager/course_form/course_edit/' . $param2));
        } elseif ($param1 == 'delete') {

            $this->is_drafted_course($param2);
            $this->crud_model->delete_course($param2);
            redirect(site_url('manager/courses'), 'refresh');
        }
    }
    ...
    public function course_form($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == 'add_course') {
            ...
            $page_data['languages'] = $this->crud_model->get_all_languages();
            $page_data['categories'] = $this->crud_model->get_categories();
            $this->load->view('backend/manager/course_add_shortcut', $page_data);
    ...
    public function change_course_status($updated_status = "")
    {
        ...
        redirect(site_url('manager/courses?category_id=' . $category_id . '&status=' . $status . '&instructor_id=' . $instructor_id . '&price=' . $price), 'refresh');
    }
    ...
    public function sections($param1 = "", $param2 = "", $param3 = "")
    {
        ...
        redirect(site_url('manager/course_form/course_edit/' . $param1));
    }
    ...
    public function lessons($course_id = "", $param1 = "", $param2 = "")
    {
        ...
        if ($param1 == 'add') {
            ...
            redirect('manager/course_form/course_edit/' . $course_id);
        } elseif ($param1 == 'edit') {
            ...
            redirect('manager/lessons/' . $this->input->post('course_id'));
        }
    ...
    public function manage_language($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'add_language') {
            ...
            if ($language == 'n-a') {
                ...
                redirect(site_url('manager/manage_language'), 'refresh');
            }
    ...
    function message($param1 = 'message_home', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'send_new') {
            ...
            redirect(site_url('manager/message/message_read/' . $message_thread_code), 'refresh');
        }

        if ($param1 == 'send_reply') {
            $this->crud_model->send_reply_message($param2); //$param2 = message_thread_code
            $this->session->set_flashdata('flash_message', get_phrase('message_sent'));
            redirect(site_url('manager/message/message_read/' . $param2), 'refresh');
        }
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update_profile_info') {
            $this->user_model->edit_user($param2);
            redirect(site_url('manager/manage_profile'), 'refresh');
        }
    ...
    public function paypal_checkout_for_instructor_revenue()
    {
        ...
        if ($payout_details['amount'] == $page_data['amount_to_pay'] && $payout_details['status'] == 0) {
            $this->load->view('backend/manager/paypal_checkout_for_instructor_revenue', $page_data);
        } else {
            $this->session->set_flashdata('error_message', get_phrase('invalid_payout_data'));
            redirect(site_url('manager/instructor_payout'), 'refresh');
        }
    }
    ...
    public function stripe_checkout_for_instructor_revenue($payout_id)
    {
        ...
        if ($payout_details['amount'] > 0 && $payout_details['status'] == 0) {
            ...
            $this->load->view('backend/manager/stripe_checkout_for_instructor_revenue', $page_data);
        } else {
            $this->session->set_flashdata('error_message', get_phrase('invalid_payout_data'));
            redirect(site_url('manager/instructor_payout'), 'refresh');
        }
    ...
    public function quizes($course_id = "", $action = "", $quiz_id = "")
    {
        ...
        redirect(site_url('manager/course_form/course_edit/' . $course_id));
    }
    ...
    public function quiz_questions($quiz_id = "", $action = "", $question_id = "")
    {
        ...
        if ($action == 'add') {
            ...
            redirect(site_url('manager/course_form/course_edit/' . $quiz_details['course_id']));
        }
    }
    ...
    public function install_theme($theme_to_install = '')
    {
        ...
        if (!in_array($theme_to_install, $uninstalled_themes)) {
            ...
            redirect(site_url('manager/theme_settings'));
        }
    ...
    public function addon($param1 = "", $param2 = "", $param3 = "")
    {
        ...
        if ($param1 == 'activate') {
            ...
            redirect(site_url('manager/addon'), 'refresh');
        }
    ...
    public function admins($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == "add") {
            ...
            redirect(site_url('manager/admins'), 'refresh');
        } elseif ($param1 == "edit") {
            // CHECK ACCESS PERMISSION
    ...
    public function coupons($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == "add") {
            ...
            redirect(site_url('manager/coupons'), 'refresh');
        } elseif ($param1 == "edit") {
            // CHECK ACCESS PERMISSION
            check_permission('coupon');
    ...
    function manage_multiple_choices_options()
    {
        ...
        $this->load->view('backend/manager/manage_multiple_choices_options', $page_data);
    }
    ...
    public function ajax_get_sub_category($category_id)
    {
        ...
        return $this->load->view('backend/manager/ajax_get_sub_category', $page_data);
    }

    public function ajax_get_section($course_id)
    {
        $page_data['sections'] = $this->crud_model->get_section('course', $course_id)->result_array();
        return $this->load->view('backend/manager/ajax_get_section', $page_data);
    }
