...
class Api_model extends CI_Model
{
	...
	public function login_go1() {
		...
		CURLOPT_POSTFIELDS => array('client_id' => '2bc8bf8aaf6ea71deb9d7d3feccb0c943f61534a','client_secret' => 'e8126b52b1682b2f3b3c8c56cb5b2b325397c623','grant_type' => 'client_credentials'),
		));
	...
	public function catalauge_play_response($token,$play_id) {
		$curl = curl_init();

		curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://api.go1.com/v2/learning-objects/'.$play_id.'/preview',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 0,
