...
<form action="<?php echo site_url('Super_Admin/quiz_questions/'.$param3.'/edit/'.$param2); ?>" method="post"
    ...
    <div class="form-group" id='multiple_choice_question'>
        ...
        <div class="input-group">
            <input type="number" class="form-control" name="number_of_options" id="number_of_options"
                ...
                value="<?php echo $question_details['number_of_options']; ?>">
    ...
    <div class="form-group options">
        ...
        <div class="input-group">
            <input type="text" class="form-control" name="options[]" id="option_<?php echo $i; ?>"
                placeholder="<?php echo get_phrase('option_').$i; ?>" required value="<?php echo $options[$i]; ?>">
...
$('#submitButton').click(function(event) {
    ...
    showLargeModal('<?php echo site_url('modal/popup/quiz_questions/'.$param3); ?>',
