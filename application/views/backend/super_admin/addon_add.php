...
<div class="row justify-content-center">
    <div class="col-xl-5">
        ...
        <div class="alert alert-danger" role="alert">
            <strong>N.B - </strong>
            <?php echo get_phrase('you_need_to_enable_the_zip_extension_on_your_server_to_install_addons'); ?>.
        </div>
        <?php endif; ?>
        <div class="card">
            <div class="card-body">
                    ...
                    <form action="<?php echo site_url('Super_Admin/addon/install'); ?>" method="post"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="purchase_code" class="form-control"
                                placeholder="<?php echo get_phrase('enter_your_valid_purchase_code'); ?>">
                        </div>
                        <?php endif; ?>
                        <div class="form-group mb-3">
