...
<h2><i class="fa fa-arrow-circle-o-right"> </i>
    <?php echo $page_title.' '.get_phrase('of').' '.$selected_category_details['name']; ?></h2>
<br />
                        ...
                        <div class="col-md-offset-3 col-md-5">
                            <select class="form-control select2" id="source" name="category_id"
                                ...
                                <option value="<?php echo $category['id']; ?>"
                                    <?php if($category['id'] == $selected_category_id) echo 'selected'; ?>>
                                    <?php echo $category['name']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-1">
                            <button type="submit" class="btn btn-lg btn-default" name="button"><i
