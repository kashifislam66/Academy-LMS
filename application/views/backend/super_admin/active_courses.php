                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            ...
                            <a href="#"
                                onclick="showAjaxModal('<?php echo base_url();?>modal/popup/mail_on_course_status_changing_modal/pending/<?php echo $course['id'].'/'.$default_category_id.'/'.$default_sub_category_id;?>');">
