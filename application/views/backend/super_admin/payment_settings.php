                ...
                <div class="card-body">
                    ...
                    <form class="" action="<?php echo site_url('Super_Admin/payment_settings/system_currency'); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-toggle="select2" id="system_currency"
                                ...
                                <option value="<?php echo $currency['code'];?>"
                                    <?php if (get_settings('system_currency') == $currency['code'])echo 'selected';?>>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-toggle="select2" id="currency_position"
                                name="currency_position" required>
                                <option value="left"
                                    <?php if (get_settings('currency_position') == 'left') echo 'selected';?>>
                                    <?php echo get_phrase('left'); ?></option>
                                <option value="right"
                                    <?php if (get_settings('currency_position') == 'right') echo 'selected';?>>
                                    <?php echo get_phrase('right'); ?></option>
                                <option value="left-space"
                                    <?php if (get_settings('currency_position') == 'left-space') echo 'selected';?>>
                                    <?php echo get_phrase('left_with_a_space'); ?></option>
                                <option value="right-space"
                                    <?php if (get_settings('currency_position') == 'right-space') echo 'selected';?>>
                        ...
                        <div class="row justify-content-md-center">
                            <div class="form-group col-md-6">
                                <button class="btn btn-block btn-primary"
                                    type="submit"><?php echo get_phrase('update_system_currency'); ?></button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form class="" action="<?php echo site_url('Super_Admin/payment_settings/paypal_settings'); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-toggle="select2" id="paypal_active"
                                name="paypal_active">
                                <option value="0" <?php if ($paypal[0]->active == 0) echo 'selected';?>>
                                    <?php echo get_phrase('no');?></option>
                                <option value="1" <?php if ($paypal[0]->active == 1) echo 'selected';?>>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-toggle="select2" id="paypal_mode"
                                name="paypal_mode">
                                <option value="sandbox" <?php if ($paypal[0]->mode == 'sandbox') echo 'selected';?>>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-toggle="select2" id="paypal_currency"
                                name="paypal_currency" required>
                                <option value=""><?php echo get_phrase('select_paypal_currency'); ?></option>
                                <?php
                            $currencies = $this->crud_model->get_paypal_supported_currencies();
                            foreach ($currencies as $currency):?>
                                <option value="<?php echo $currency['code'];?>"
                                    <?php if (get_settings('paypal_currency') == $currency['code'])echo 'selected';?>>
                                    <?php echo $currency['code'];?>
                                </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sandbox_client_id" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sandbox_secret_key" class="form-control"
                                value="<?php echo $paypal[0]->sandbox_secret_key;?>" required />
                            <?php else: ?>
                            <input type="text" name="sandbox_secret_key" class="form-control"
                                placeholder="<?php echo get_phrase('no_secret_key_found'); ?>" required />
                            <?php endif; ?>
                        </div>

                        <div class="form-group">
                            <label><?php echo get_phrase('client_id').' ('.get_phrase('production').')'; ?></label>
                            <input type="text" name="production_client_id" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="production_secret_key" class="form-control"
                                value="<?php echo $paypal[0]->production_secret_key;?>" required />
                            <?php else: ?>
                            <input type="text" name="production_secret_key" class="form-control"
                                placeholder="<?php echo get_phrase('no_secret_key_found'); ?>" required />
                            <?php endif; ?>
                        ...
                        <div class="row justify-content-md-center">
                            <div class="form-group col-md-6">
                                <button class="btn btn-block btn-primary"
                                    type="submit"><?php echo get_phrase('update_paypal_keys'); ?></button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="" action="<?php echo site_url('Super_Admin/payment_settings/stripe_settings'); ?>"
                        ...
                        <div class="form-group">
                            <label><?php echo get_phrase('active'); ?></label>
                            <select class="form-control select2" data-toggle="select2" id="stripe_active"
                                name="stripe_active">
                                <option value="0" <?php if ($stripe[0]->active == 0) echo 'selected';?>>
                                    <?php echo get_phrase('no');?></option>
                                <option value="1" <?php if ($stripe[0]->active == 1) echo 'selected';?>>
                                    <?php echo get_phrase('yes');?></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-toggle="select2" id="stripe_currency"
                                name="stripe_currency" required>
                                <option value=""><?php echo get_phrase('select_stripe_currency'); ?></option>
                                <?php
                        $currencies = $this->crud_model->get_stripe_supported_currencies();
                        foreach ($currencies as $currency):?>
                                <option value="<?php echo $currency['code'];?>"
                                    <?php if (get_settings('stripe_currency') == $currency['code'])echo 'selected';?>>
                                    <?php echo $currency['code'];?>
                                </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="secret_live_key" class="form-control"
                                value="<?php echo $stripe[0]->secret_live_key;?>" required />
                        </div>

                        <div class="form-group">
                            <label><?php echo get_phrase('live_public_key'); ?></label>
                            <input type="text" name="public_live_key" class="form-control"
                        ...
                        <div class="row justify-content-md-center">
                            <div class="form-group col-md-6">
                                <button class="btn btn-block btn-primary"
                                    type="submit"><?php echo get_phrase('update_stripe_keys'); ?></button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="" action="<?php echo site_url('Super_Admin/payment_settings/razorpay_settings'); ?>"
                        ...
                        <div class="form-group">
                            <label><?php echo get_phrase('active'); ?></label>
                            <select class="form-control select2" data-toggle="select2" id="razorpay_active"
                                name="razorpay_active">
                                <option value="0" <?php if ($razorpay[0]->active == 0) echo 'selected';?>>
                                    <?php echo get_phrase('no');?></option>
                                <option value="1" <?php if ($razorpay[0]->active == 1) echo 'selected';?>>
                                    <?php echo get_phrase('yes');?></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-toggle="select2" id="razorpay_currency"
                                name="razorpay_currency" required>
                                <option value=""><?php echo get_phrase('select_razorpay_currency'); ?></option>
                                <?php
                        $currencies = $this->crud_model->get_currencies();
                        foreach ($currencies as $currency):?>
                                <option value="<?php echo $currency['code'];?>"
                                    <?php if (get_settings('razorpay_currency') == $currency['code'])echo 'selected';?>>
                                    <?php echo $currency['code'];?>
                                </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="key" class="form-control" value="<?php echo $razorpay[0]->key;?>"
                                required />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="secret_key" class="form-control"
                                value="<?php echo $razorpay[0]->secret_key;?>" required />
                            <?php else: ?>
                            <input type="text" name="secret_key" class="form-control"
                                placeholder="<?php echo get_phrase('no_secret_key_found'); ?>" required />
                            <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="color" name="theme_color" class="form-control"
                                value="<?php echo $razorpay[0]->theme_color;?>" required />
                        </div>

                        <div class="row justify-content-md-center">
                            <div class="form-group col-md-6">
                                <button class="btn btn-block btn-primary"
                                    type="submit"><?php echo get_phrase('update_razorpay_keys'); ?></button>
                            </div>
                        </div>
                    </form>
                </div>
