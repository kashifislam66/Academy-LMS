    ...
    <div class="col-md-12">
        <div class="grid simple">
            <div class="grid-title no-border">
                <h4><?php echo get_phrase('course_title'); ?> : <span
                        style="font-weight: 800;"><?php echo $course_details['title']; ?></span></h4>
                <h4><?php echo get_phrase('lesson_title'); ?> : <span
                        style="font-weight: 800;"><?php echo $lesson_details['title']; ?></span></h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;">
                        ...
                        <a href="<?php echo base_url().'uploads/lesson_files/'.$lesson_details['attachment']; ?>"
                            ...
                            <i class="entypo-download" style="font-size: 20px;"></i>
