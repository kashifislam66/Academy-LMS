                ...
                <div class="chat-conversation">
                    <ul class="conversation-list slimscroll" style="max-height: 250px;">
                        ...
                        <li class="clearfix <?php if($first_sender != $sender_id )echo 'odd'; ?>">
                            <div class="chat-avatar">
                                <a href="#">
                                    <img src="<?php echo $this->user_model->get_user_image_url($sender_id);?>"
                                        alt="image" class="mr-3 d-none d-sm-block avatar-sm rounded-circle"
                            ...
                            <div class="conversation-text">
                                ...
                                <small
                                    class="message_sending_time"><?php echo date("d M, Y" , $row['timestamp']);?></small>
                            </div>
                        </li>
                        <?php endforeach;?>
                    </ul>
                    <form method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <button type="submit"
                                    class="btn btn-danger chat-send btn-block waves-effect waves-light"><?php echo get_phrase('sent_message'); ?></button>
                            </div>
                        </div>
                    </form>
