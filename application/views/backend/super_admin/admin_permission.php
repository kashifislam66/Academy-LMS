            ...
            <div class="card-body">
                ...
                <div class="text-muted">
                    <small> <strong><?php echo get_phrase('note'); ?></strong> :
                        <?php echo get_phrase('you_can_toggle_the_switch_for_enabling_or_disabling_a_feature_to_access'); ?>.</small>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="checkbox" class=""
                                        ...
                                        data-switch="bool"
                                        onchange="setPermission('<?php echo $permission_assign_to['id'] . '-' . $module; ?>')"
                                        <?php echo $module_permission ? "checked" : ""; ?> />
    ...
    $.ajax({
        ...
        success: function(response) {
            $.NotificationApp.send("<?php echo get_phrase('heads_up'); ?>!",
                '<?php echo get_phrase('permission_updated'); ?>', "top-right", "rgba(0,0,0,0.2)",
                "info");
        }
    });
}
