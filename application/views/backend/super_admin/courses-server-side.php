            ...
            <div class="card-body p-0">
                <div class="row no-gutters">
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('super_user/courses'); ?>" class="text-secondary">
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row justify-content-center" action="<?php echo site_url('super_user/courses'); ?>"
                    method="get">
                    <!-- Course Categories -->
                    <div class="col-xl-3">
                ...
                <div class="table-responsive-sm mt-4">
                    ...
                    <table id="course-datatable-server-side" class="table table-striped dt-responsive nowrap"
