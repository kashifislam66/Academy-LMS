        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i>
                    <?php echo get_phrase('instructor_settings'); ?></h4>
            </div>
        </div>
    </div>
</div>
                ...
                <form action="<?php echo site_url('Super_Admin/instructor_settings/update'); ?>" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" data-toggle="select2" name="allow_instructor" required>
                            <option value="1" <?php if(get_settings('allow_instructor') == 1) echo 'selected'; ?>>
                                <?php echo get_phrase('yes'); ?></option>
                            <option value="0" <?php if(get_settings('allow_instructor') == 0) echo 'selected'; ?>>
                                <?php echo get_phrase('no'); ?></option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label
                            for="instructor_application_note"><?php echo get_phrase('instructor_application_note'); ?></label>
                        <div class="form-group">
                            <textarea class="form-control" name="instructor_application_note" rows="8"
                                cols="80"><?php echo get_settings('instructor_application_note'); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-7">
                            <button type="submit"
                                class="btn btn-primary btn-block"><?php echo get_phrase('update_settings'); ?></button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo site_url('Super_Admin/instructor_settings/update'); ?>" method="post"
                    ...
                    <div class="form-group">
                        <label
                            for="instructor_revenue"><?php echo get_phrase('instructor_revenue_percentage'); ?></label>
                        <div class="input-group">
                            <input type="number" name="instructor_revenue" id="instructor_revenue" class="form-control"
                                onkeyup="calculateAdminRevenue(this.value)" min="0" max="100"
                                value="<?php echo get_settings('instructor_revenue'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" name="admin_revenue" id="admin_revenue" class="form-control" value="0"
