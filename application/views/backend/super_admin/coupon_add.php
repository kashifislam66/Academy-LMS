        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <form class="required-form" action="<?php echo site_url('Super_Admin/coupons/add'); ?>"
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip"
                                        ...
                                        data-original-title="<?php echo get_phrase('generate_a_random_coupon_code'); ?>"
                                        onclick="generateARandomCouponCode()"><i class="mdi mdi-sync"></i>
                                        <?php echo get_phrase('generate_random'); ?></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="expiry_date"><?php echo get_phrase('expiry_date'); ?><span
                                    class="required">*</span></label>
                            <input type="text" name="expiry_date" class="form-control date" id="expiry_date"
