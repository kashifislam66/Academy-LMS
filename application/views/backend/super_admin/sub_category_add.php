    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                <div class="row">
                    <form action="<?php echo site_url('Super_Admin/sub_categories/0/add'); ?>" method="post" role="form"
                        class="form-horizontal form-groups-bordered">
                        <div class="col-md-12 col-sm-12 col-xs-12">

                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo get_phrase('sub_category_code'); ?></label>
                                <div class="col-sm-5">
                                    <input type="text" name="code" class="form-control" readonly
                                        value="<?php echo substr(md5(rand(0, 1000000)), 0, 10); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo get_phrase('sub_category_title'); ?></label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-5">
                                    <button class="btn btn-success" type="submit"
                                        name="button"><?php echo get_phrase('add_sub_category'); ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
