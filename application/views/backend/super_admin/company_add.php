            ...
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i>
                    ...
                    <a href="<?php echo site_url('super_admin/companies'); ?>"
                        class="btn btn-outline-primary btn-rounded alignToTitle"> <i class="mdi mdi-arrow-left"></i>Back
                        To Companies</a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/admins/add'); ?>"
