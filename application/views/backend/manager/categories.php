    ...
    <div class="col-md-6 col-lg-6 col-xl-4 on-hover-action" id="<?php echo $category['id']; ?>">
        <div class="card d-block">
            <img class="card-img-top"
                src="<?php echo base_url('uploads/thumbnails/category_thumbnails/' . $category['thumbnail']); ?>"
                alt="Card image cap">
            <div class="card-body">
                <h4 class="card-title mb-0"><i class="<?php echo $category['font_awesome_class']; ?>"></i>
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item on-hover-action" id="<?php echo $sub_category['id']; ?>">
                    ...
                    <?php /* <span class="category-action" id='category-delete-btn-<?php //echo $sub_category['id']; ?>'
                    style="float: right; margin-left: 5px; display: none; height: 20px;">
                    <a href="javascript::" class="action-icon"
                        onclick="confirm_modal('<?php //echo site_url('admin/categories/delete/' . $sub_category['id']); ?>');">
                    ...
                    <span class="category-action" id='category-edit-btn-<?php echo $sub_category['id']; ?>'
                        ...
                        <a href="<?php echo site_url('admin/category_form/edit_category/' . $sub_category['id']); ?>"
