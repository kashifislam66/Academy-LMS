...
function showAjaxModal(url) {
    ...
    jQuery('#modal_ajax .modal-body').html(
        '<div class="w-100 text-center pt-5"><img class="mt-5 mb-5" width="80px" src="<?= base_url(); ?>assets/global/gif/page-loader-2.gif"></div>'
    );
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="margin-top:100px;">
            ...
            <div class="modal-footer" style="margin:0px; border-top:0px; text-align:center;">
                <a href="#" class="btn btn-danger btn-yes" id="delete_link"
                    data-bs-dismiss="modal"><?php echo site_phrase('yes');?></a>
                <button type="button" class="btn btn-info btn-cancel"
                    data-bs-dismiss="modal"><?php echo site_phrase('no');?></button>
            </div>
        </div>
    </div>
</div>
