...
<div class="icon">
    ...
    <span class="number"><?php echo sizeof($this->crud_model->getWishListsOfManager()); ?></span>
</div>
<div class="dropdown course-list-dropdown corner-triangle top-right">
    <div class="list-wrapper">
        ...
        <div class="dropdown-footer">
            <a href="<?php echo site_url('home/my_manager_wishlist'); ?>"><?php echo site_phrase('go_to_wishlist'); ?></a>
        </div>
    </div>
