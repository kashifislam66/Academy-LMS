                ...
                <!-- <div class="my-course-search-bar">
                    <form action="">
                        <div class="input-group">
                            <input type="text" class="form-control py-2" placeholder="<?php //echo site_phrase('search_my_courses'); ?>" onkeyup="getMyWishListsByManagerSearchString(this.value)">
                    ...
                    <div class="course-box-wrap">
                        <div class="course-box">
                            <div class="course-image">
                                <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($my_course['title'])) . '/' . $my_course['id']); ?>"><img src="<?php echo $my_course['thumbnail']; ?>" alt="" class="img-fluid"></a>
                                ...
                                <?php  $eventFunction = '';
                                    ...
                                    <button type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="" style="cursor : auto;" onclick="<?php echo $eventFunction; ?>" id="<?php echo $my_course['id']; ?>">
...
<script type="text/javascript">
    function getMyWishListsBySearchString(search_string) {
        $.ajax({
            type: 'POST',
            url: '<?php echo site_url('home/get_my_wishlists_by_manager_search_string'); ?>',
            data: {
